...
enum AnimationDirection
{
	...
	ANIM_DIR_DASH_LEFT, ANIM_DIR_DASH_RIGHT,ANIM_DIR_STANDBY,ANIM_DIR_APPEARS,ANIM_DIR_DISAPPEARS,ANIM_DIR_IN_PORTAL, ANIM_DIR_OUT_PORTAL,ANIM_DIR_INVICIBLE
};
